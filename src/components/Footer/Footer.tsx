                  ...
                  <div className="footer-widgets flex-[0_0_100%] max-w-full relative w-full px-[15px] md:flex-[0_0_50%] md:max-w-[50%]  lg:basis-0 lg:grow min-w-0">
                    <div className=" widget_media_image mb-[48px] ">
                      <div className="widget-content">
                        <img className='mx-auto md:mx-0' width={63} height={56} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/12/Logo_light1.svg"  alt=""  style={{maxWidth: '100%', height: 'auto'}}  />
                      </div>
                    </div>
                      ...
                      <div className="widget-content">			
                        <div className="text-widget">
                          ...
                          <p className='flex justify-center md:justify-start'>
                            <img decoding="async" loading="lazy" className="align-middle mt-0 mr-[20px] mb-[20px] ml-0  " style={{width: '32px', marginRight: '10px'}} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/12/visa-1.svg" alt="" width={32} height={32} />
                            <img decoding="async" loading="lazy" className="align-middle mt-0 mr-[20px] mb-[20px] ml-0  " style={{width: '32px', marginRight: '10px'}} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/12/american-express-1.svg" alt="" width={32} height={32} />
                            <img decoding="async" loading="lazy" className="align-middle mt-0 mr-[20px] mb-[20px] ml-0  " style={{width: '32px', marginRight: '5px'}} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/12/maestro-1.svg" alt="" width={32} height={32} />
                          </p>
                        </div>
                      </div>
                    </div>							
                    ...
                    <div className="widget widget_st_latest_posts_widget mb-12 text-center md:text-start">
                      <div className="widget-content">
                        ...
                        <div className="latest-posts inline-block mx-auto text-left ">
                          <div className="media overflow-hidden flex items-start">
                            <div className="pull-left pr-[10px] float-left">
                              <a href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/alternative-methods-of-food-delivery-logistic/">
                                <img width={64} height={64} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/e0d393f3ae7b0057ed6a226d540d8991b3955ac1-64x64.png" className="img-responsive text-white-color" alt=""  srcSet="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/e0d393f3ae7b0057ed6a226d540d8991b3955ac1-64x64.png 64w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/e0d393f3ae7b0057ed6a226d540d8991b3955ac1-500x500.png 500w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/e0d393f3ae7b0057ed6a226d540d8991b3955ac1-100x100.png 100w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/e0d393f3ae7b0057ed6a226d540d8991b3955ac1-150x150.png 150w" sizes="(max-width: 64px) 100vw, 64px" />
                              </a>
                            </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white-color' href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/alternative-methods-of-food-delivery-logistic/">Alternative methods of food delivery logistic</a>
                            </h3>
                        ...
                        <div className="media mt-5 overflow-hidden flex items-start">
                          <div className="pull-left pr-[10px] float-left">
                            <a href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/where-and-how-do-we-keep-the-ingridients-fresh/">
                              <img width={64} height={64} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0dd2aec8932ec4054b333bff3c4299bb4a6daba9-64x64.png" className="img-responsive text-white-color" alt=""  srcSet="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0dd2aec8932ec4054b333bff3c4299bb4a6daba9-64x64.png 64w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0dd2aec8932ec4054b333bff3c4299bb4a6daba9-500x500.png 500w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0dd2aec8932ec4054b333bff3c4299bb4a6daba9-100x100.png 100w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0dd2aec8932ec4054b333bff3c4299bb4a6daba9-150x150.png 150w" sizes="(max-width: 64px) 100vw, 64px" />
                            </a>
                          </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white-color' href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/where-and-how-do-we-keep-the-ingridients-fresh/">Where and how do we keep the ingridients fresh?
                              </a>
                            </h3>
                            <div className="entry-meta text-[85%] text-[#888] font-normal">
                        ...
                        <div className="media mt-5 overflow-hidden flex items-start">
                          <div className="pull-left pr-[10px] float-left">
                            <a href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/not-eating-meat-is-decision-eating-meat-is-an-instict/">
                              <img width={64} height={64} src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0cc98500736ecd74e6faae28718f141952506617-64x64.png" className="img-responsive text-white-color" alt="" decoding="async" loading="lazy" srcSet="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0cc98500736ecd74e6faae28718f141952506617-64x64.png 64w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0cc98500736ecd74e6faae28718f141952506617-500x500.png 500w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0cc98500736ecd74e6faae28718f141952506617-100x100.png 100w, http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/0cc98500736ecd74e6faae28718f141952506617-150x150.png 150w" sizes="(max-width: 64px) 100vw, 64px" />
                            </a>
                        </div>
                          <div className="media-body ml-[7px] table-cell align-top flex-1">
                            <h3 className="entry-title text-md font-semibold mb-1.5 leading-normal pt-0 m-0">
                              <a className='text-white-color' href="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/not-eating-meat-is-decision-eating-meat-is-an-instict/">Not eating meat is decision, eating meat is an instict
                              </a>
                            </h3>
  ...
  <div className="section-inner flex flex-wrap mx-[-15px]">
    <div className="footer-credits basis-0 grow min-w-0 max-w-full relative w-full px-[15px]">
      <div className="copyright pt-12 border-t-2 border-t-border-footer text-gray-color text-center max-w-full border-solid relative w-full px-[15px]">
                2023				Design by 
        <a className='text-gray-color' href="http://themeforest.net/user/merkulove/portfolio?irgwc=1&clickid=WHBUxY0JUxyLRwlwUx0Mo3EFUkE0Gn3WeVfJxQ0&iradid=275988&irpid=1187830&iradtype=ONLINE_TRACKING_LINK&irmptype=mediapartner&mp_value1=&utm_campaign=af_impact_radius_1187830&utm_medium=affiliate&utm_source=impact_radius" target="_blank">Merkulove
        </a>. Development by 
        <a className='text-gray-color' href="http://themeforest.net/user/rayoflightt?ref=rayoflightt" target="_blank">RayoflightThemes
