...
const Banner = () => {
  return (
    ...
    <div className=" hero-bg bg-hero-pattern absolute bottom-0 top-auto w-full max-w-full left-0 h-auto text-white-color md:top-[250px] md:h-[850px] md:left-1/2 lg:left-[51%] 2xl:left-[50.8%] 3xl:left-[50.7%] 3xl:top-[200px] 3xl:max-w-[540px]  ">
      <div className="hero-bg-text animate__animated animate__bounceIn relative pt-12 pb-6 px-3 md:absolute md:bottom-0 md:pb-10 md:pl-[38px] md:pr-0 md:pt-0 overflow-hidden">
        <h2 className='mb-0 font-semibold text-[18px] leading-[27.28px] text-white-color'>CALL US:</h2>
        <h3 className='font-extrabold text-3xl 3xs:text-4xl leading-[60px]'>+123 4567 8905</h3>
      </div>
    </div>
    <div className="hero-img animate__animated animate__fadeInRight absolute z-[1] top-1/2 w-full 2xs:top-[40%] 2xs:w-full md:top-0 md:w-full">
      <img className=' mt-0 ml-[50%] max-w-[300px] w-auto  2xs:max-w-[400px] md:mt-[102px] md:ml-[45%] md:max-w-[900px]' src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/1-2.png" alt="" />
    </div>
    <div className="hero-text animate__animated animate__fadeInLeft absolute z-[1] top-0 w-full ">
      ...
      <h1 className='text-6xl leading-[1] md:text-[80px] lg:text-[120px] mb-0 font-[900] ml-[-5px] '>BEST</h1>
      <h2 className='text-6xl leading-[1] md:text-[80px] lg:text-[120px] font-[900] ml-[-5px] mb-3'>BURGERS</h2>
      ...
      <a href="#" className='hidden md:block bg-white-color max-w-[337px] ml-[139px] lg:mt-[104px] md:mt-20 shadow-none no-underline'>
        <div className='items-center flex'>
          <div className='max-w-full px-4'>
            <img className='mt-[-35px] ml-[-155px] mb-[-2px] max-w-[190px]' src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/123.png" alt="" />
          </div>
          <div className='px-4'>
