                        ...
                        <div>
                           <div className=" m-0 p-0 text-center items-center flex flex-wrap">
                              <div className="mb-6 px-[10px] flex-[0_0_100%] max-w-[100%] xs:flex-[0_0_50%] xs:max-w-[50%] relative w-full">
                                 <img
                                    src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/2.png"
                                    alt=""
                              ...
                              <div className="px-[10px] flex-[0_0_100%] max-w-[100%] relative w-full xs:flex-[0_0_50%] xs:max-w-[50%] lg:flex=[0_0_33.333333%] lg:max-w-[33.333333%] ">
                                 <div className="pl-[2px] text-center xs:text-start">
                                    ...
                                    <p className="mb-0 pt-0 ">
                                       Quisque nec libero ut sapien dictum
                                       commodo. Nam ac felis id libero rutrum
                                       pharetra eu non lacus
                                    </p>
                                    <h6 className="flex items-center justify-center xs:justify-start mt-[18px] mb-[12px] mx-0 md:mb-6  text-sm leading-6 font-lato font-normal text-dark-gray-color">
                                       <span className="flex items-center mr-[30px] ">
                                          <img
                                             src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/weight-1.png"
                                             alt=""
                                       ...
                                       <span className="flex items-center">
                                          <img
                                             src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/fire-1.png"
                                             alt=""
                                             className="pb-[5px] pr-[3px] h-auto max-w-full align-middle"
                                          />
                                          Spicy
                                    ...
                                    <div className="m-0 p-0 flex  flex-wrap ">
                                       <div className="relative w-full pr-0 pl-0 flex-[0_0_100%] max-w-full   md:pr-[1rem] md:flex-[0_0_auto] md:w-auto md:max-w-full ">
                                          <h5 className="px-0 md:pr-3 mt-[-2px] font-Nunito Sans text-4xl leading-[72px] md:mb-0 font-black text-black-navy-color ">
                                             $15
                                          </h5>
                                       </div>
                        ...
                        <div>
                           <div className=" m-0 p-0 text-center items-center flex flex-wrap">
                              <div className="mb-6 px-[10px] order-1 flex-[0_0_100%] max-w-[100%] xs:flex-[0_0_50%] xs:order-4 xs:max-w-[50%] relative w-full md:text-right">
                                 <img
                                    src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/3.png"
                                    alt=""
                                 ...
                                 <div className="best-product-textl mr-0 xs:mr-5 pl-[2px] text-center  lg:mr-[-17px] xs:text-right">
                                    ...
                                    <div className="flex flex-wrap m-0 p-0">
                                       ...
                                       <div className="p-0 relative w-full md:flex-[0_0_66.666667%] md:max-w-[66.666667%]">
                                          <p className="mb-0 pt-0">
                                             Quisque nec libero ut sapien dictum
                                             commodo. Nam ac felis id libero
                                             rutrum pharetra eu non lacus
                                          </p>
                                       </div>
                                    </div>
                                    <h6 className="flex items-center justify-center  xs:justify-end mt-[18px] mb-[12px]  mx-0 md:mb-6  text-sm leading-6 font-lato font-normal text-dark-gray-color">
                                       <span className="flex items-center mr-[30px] ">
                                          <img
                                             src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/weight-1.png"
                                             alt=""
                                    ...
                                    <div className="m-0 p-0 flex  flex-wrap ">
                                       <div className="relative w-full pr-0 pl-0 flex-[0_0_100%]   md:pr-[1rem] md:flex-[0_0_auto] md:w-auto md:basis-0 md:flex-grow md:min-w-0 md:max-w-full">
                                          <h5 className="px-0 md:pr-3 mt-[-2px] font-Nunito Sans text-4xl leading-[72px] mb-0 font-black text-black-navy-color ">
                                             $12
                                          </h5>
                                       </div>
                     ...
                     <div className="w-full">
                        <div>
                           <div className=" m-0 p-0 text-center items-center flex flex-wrap">
                              <div className="mb-6 px-[10px] flex-[0_0_100%] max-w-[100%] xs:flex-[0_0_50%] xs:max-w-[50%] relative w-full">
                                 <img
                                    src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/10/4.png"
                                    alt=""
                                    className="w-full max-w-[520px] h-auto border-none rounded shadow-none"
                                 />
                              </div>
