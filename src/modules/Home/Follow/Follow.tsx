      ...
      <>
         <section className="follow-title mb-[24px] xl:mb-[46px] relative text-center">
            <div className="elemental-container">
               <div className="relative min-h-[1px] flex w-full animate__animated animate__fadeInDown">
                     ...
                     <div className="w-full relative">
                        <div className="instagram-wrapper ">
                           <div className="instagram-title m-0 p-0 items-center  flex-wrap justify-center flex  flex-[0_0_auto] w-auto max-w-full relative">
                              ...
                              <div className="title relative mb-0 font-normal uppercase text-[20px] text-black-navy-color font-nunito flex-[0_0_auto] w-auto max-w-full break-words">
                                 @burgos_cafee
                              </div>
                           </div>
                        </div>
