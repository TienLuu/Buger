               ...
               <div className="w-full  relative min-h-[1px] flex animate__animated animate__bounceIn">
                  <div className="p-[10px] flex relative w-full flex-wrap content-start">
                     <div className="w-full relative">
                        <div className="">
                           <h3 className="main-title mb-0 text-[44px] font-extrabold leading-[56px] text-black-navy-color uppercase">
                              How it works
                           </h3>
                        </div>
                     </div>
                                    ...
                                    <div className="">
                                       <div className="circle-box1 text-center max-w-[300px] mx-auto my-0 ">
                                          <div className="circle-image mx-auto mt-0 mb-[24px] bg-instruction rounded-[500px]">
                                             <img
                                                className="h-auto max-w-full rounded-none shadow-none border-0"
                                                src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/burgers-1-1.png"
                                             />
                                          </div>
                                          <div className="circle-text max-w-[220px] mx-auto my-0">
                                             <h3 className="text-3xl font-extrabold leading-[38px] text-black-navy-color">
                                                Select your food
                                             </h3>
                                             <p className="mx-auto max-w-[250px]">
                                       ...
                                       <div className="circle-box1 text-center max-w-[300px] mx-auto my-0">
                                          <div className="flex flex-wrap m-0 p-0">
                                             <div className="circle-text order-12 flex-[0_0_100%w] max-w-[220px] mx-auto my-0">
                                                ...
                                                <p className="mx-auto max-w-[250px]">
                                                   Quisque nec libero dictum
                                                   commodo. Nam ac felis id
                                                   libero
                                                </p>
                                             </div>
                                             <div className="circle-image mx-auto mt-0 mb-[24px] bg-instruction rounded-[500px] order-1 md:order-12 flex-[0_0_100%] max-w-full relative w-full pr-[15px] pl-[15px]">
                                                <img
                                                   className="h-auto max-w-full rounded-none shadow-none border-0"
                                                   src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/55555-1.png"
                                                />
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div className="">
                                       <div className="circle-box1 text-center max-w-[300px] mx-auto my-0">
                                          <div className="circle-image mx-auto mt-0 mb-[24px] bg-instruction rounded-[500px]">
                                             <img
                                                className="h-auto max-w-full rounded-none shadow-none border-0"
                                                src="http://rayoflightthemes.com/wordpress-themes/burgos-wordpress-theme/wp-content/uploads/2020/11/121-1.png"
                                             />
                                          </div>
                                          <div className="circle-text max-w-[220px] mx-auto my-0">
                                             <h3 className="text-3xl font-extrabold leading-[38px] text-black-navy-color">
